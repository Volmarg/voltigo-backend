 ...
 */
final class Version20220726191433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_search_result ADD location_name LONGTEXT DEFAULT NULL, ADD max_distance INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_search_result DROP location_name, DROP max_distance');
