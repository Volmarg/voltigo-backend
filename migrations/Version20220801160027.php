 ...
 */
final class Version20220801160027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE email CHANGE sender_id sender_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE email CHANGE sender_id sender_id INT NOT NULL');
